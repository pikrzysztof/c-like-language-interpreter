...
type Przetwarzacz a = ExceptT String (RWST (Sr.Srodowisko Loc) () St.Stan IO) a
...
run v p s = let ts = myLLexer s in case  p ts of
           Bad s -> do
             ...
             exitFailure
           Ok tree -> do
             runReaderT (runExceptT $ sprawdz_typy tree) Sr.srodowiskoZero
...
zlap_wyjatek :: String -> ExceptT String (RWST (Sr.Srodowisko Loc) () St.Stan IO) ()
zlap_wyjatek x = do
